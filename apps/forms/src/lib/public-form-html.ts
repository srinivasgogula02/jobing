...
export function renderPublicForm(input: { definition: FormDefinition; endpointId: string; action: string; submissionId?: string; message?: string; closedMessage?: string; formError?: string; errors?: Record<string,string>; values?: Record<string,unknown> }) {
