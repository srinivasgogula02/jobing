      ...
      <div className="min-h-full bg-[#f7f8f4] px-4 py-6 sm:px-6 lg:px-10 lg:py-9">
        <div className="mx-auto max-w-6xl">
          <header className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
            ...
            <Link href="/pages" style={{ color: "#fff" }} className="inline-flex min-h-12 items-center justify-center gap-2 rounded-[4px] bg-[#151914] px-5 font-semibold hover:bg-[#293025] focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-[#719500]">
