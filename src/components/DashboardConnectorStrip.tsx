  ...
  return (
    <section className="flex flex-col gap-4 rounded-[18px] border border-[#dfe3da] bg-white p-4 shadow-[0_8px_30px_rgba(31,40,25,.04)] sm:flex-row sm:items-center sm:justify-between sm:p-5" aria-label="Jobing AI connector">
      ...
      <div className="flex shrink-0 gap-2">
        ...
        <Link href="/connector" style={{ color: "#fff" }} className="inline-flex min-h-11 flex-1 items-center justify-center gap-2 rounded-xl bg-[#151914] px-4 text-sm font-semibold hover:bg-[#293025] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#719500] sm:flex-none">
