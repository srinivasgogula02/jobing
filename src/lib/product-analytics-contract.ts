...
export const MCP_TOOL_METADATA: Record<string, {
  ...
  list_page_domains: { productArea: "pages", toolAction: "list", accessMode: "read" },
  add_page_domain: { productArea: "pages", toolAction: "create", accessMode: "write" },
  verify_page_domain: { productArea: "pages", toolAction: "update", accessMode: "write" },
  set_page_address: { productArea: "pages", toolAction: "update", accessMode: "write" },
  remove_page_domain: { productArea: "pages", toolAction: "delete", accessMode: "destructive" },
